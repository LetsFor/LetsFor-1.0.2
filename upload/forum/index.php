	...
	case 'tema':
		...
		if (empty($user['id'])) {
			...
			if ($forum_t['us'] != $user['id'])  {
				echo '<li><a class="dropdown-item" href="' . homeLink() . '/complaint"><span class="fontawesome_in_menu"><i class="fas fa-flag"></i><span class="text_in_menu">Пожаловаться</span></span></a></li>';
			}
